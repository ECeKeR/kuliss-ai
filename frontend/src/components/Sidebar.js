export const SidebarHtml = (t) => `
<div class="sidebar-header" style="--webkit-app-region: drag;">
  <div class="logo-wrap">
    <div class="logo-icon" style="background: transparent; box-shadow: none;">
      <img src="/logo.svg" alt="Kuliss" style="width: 24px; height: 24px;" />
    </div>
    <div class="logo-text-area">
      <span class="logo-name">Kuliss</span>
      <span class="logo-sub">AI Manager</span>
    </div>
  </div>
</div>

<nav class="sidebar-nav">
  <span class="nav-section">${t('General')}</span>
  ...
  <a href="#" class="nav-item" data-page="conversations">
    ...
    <span class="nav-badge" id="badge-conversations" style="display:none">0</span>
  </a>
  ...
  <span class="nav-section">${t('Bot Settings')}</span>

  <a href="#" class="nav-item" data-page="prompt">
    <span class="nav-icon">
  ...
  <a href="#" class="nav-item" data-page="blocked">
    <span class="nav-icon">
    ...
    <span>${t('Blocked')}</span>
    <span class="nav-badge" id="badge-blocked" style="display:none; background: var(--danger)">0</span>
  </a>
...
<div class="sidebar-footer">
  <div class="model-pill">
    <span class="pulse-dot idle" id="status-dot-mini"></span>
    <select id="quick-model-select" class="sidebar-model-select">
      <option value="">...</option>
    </select>
  </div>
</div>
